...
_ZH_TW: dict[str, str] = {
    ...
    "tooltip.row.toggle.resume": "恢復監聽此頻道",
...
_EN: dict[str, str] = {
    ...
    "tooltip.row.toggle.resume": "Resume monitoring this channel",
...
_JA: dict[str, str] = {
    ...
    "tooltip.row.toggle.resume": "このチャンネルの監視を再開",
    "tooltip.row.status.upcoming": "待機中",
...
_KO: dict[str, str] = {
    ...
    "tooltip.row.toggle.resume": "이 채널 감시 재개",
