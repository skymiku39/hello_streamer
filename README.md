...
| 平台 | 檔案 |
| --- | --- |
| Windows x64 | `HelloStreamer-v1.1.8-windows-x64.exe` |
| Linux x64 | `HelloStreamer-v1.1.8-linux-x64.tar.gz` |
| Linux ARM64 / Raspberry Pi 64-bit | `HelloStreamer-v1.1.8-linux-arm64.tar.gz` |
...
| 自動關閉空白分頁 | 僅關閉已變成新分頁／瀏覽器空殼的追蹤視窗；直播是否結束由監控狀態決定，不靠標題關鍵字判斷。 |
| 開啟後先最小化 | 視窗開啟後最小化。 |
