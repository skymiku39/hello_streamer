...
| 平台 | 檔案 |
| --- | --- |
| Windows x64 | `HelloStreamer-v1.1.3-windows-x64.exe` |
| Linux x64 | `HelloStreamer-v1.1.3-linux-x64.tar.gz` |
| Linux ARM64 / Raspberry Pi 64-bit | `HelloStreamer-v1.1.3-linux-arm64.tar.gz` |
