...
| 平台 | 檔案 |
| --- | --- |
| Windows x64 | `HelloStreamer-v0.9.13-windows-x64.exe` |
| Linux x64 | `HelloStreamer-v0.9.13-linux-x64.tar.gz` |
| Linux ARM64 / Raspberry Pi 64-bit | `HelloStreamer-v0.9.13-linux-arm64.tar.gz` |
...
| 獨立視窗 | 使用瀏覽器的新視窗開啟直播頁。勾選純淨播放器視窗時，會同步啟用此設定。若取消勾選且未啟用 App Mode，直播頁會以**分頁**開啟，程式無法追蹤或自動關閉該分頁。 |
