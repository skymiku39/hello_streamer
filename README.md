...
| 平台 | 檔案 |
| --- | --- |
| Windows x64 | `HelloStreamer-v0.6.0-windows-x64.exe` |
| Linux x64 | `HelloStreamer-v0.6.0-linux-x64.tar.gz` |
| Linux ARM64 / Raspberry Pi 64-bit | `HelloStreamer-v0.6.0-linux-arm64.tar.gz` |
